...
const AttractionsPage = async () => {
	const attractions: AttractionType[] = await getAttraction();
		...
		<main className="pb-40">
			<section className="rounded-container bg-primaryc pb-32 pt-48">
				<div className="container mx-auto px-4">
					...
					<p className="text-white text-center mt-4 mx-auto max-w-3xl text-xl">Zapoznaj się z naszą ofertą i wybierz swojego wymarzonego dmuchańca.</p>
				</div>
			</section>
