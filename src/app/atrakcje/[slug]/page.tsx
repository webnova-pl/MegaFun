...
export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
  ...
  return {
    ...
    description: attraction.shortDescription || `Wypożycz ${attraction.name} na imprezę dla dzieci. Profesjonalny wynajem dmuchańców w Przemyślu, Jarosławiu i okolicach.`,
    keywords: [
      `${attraction.name}`, 
      "wynajem dmuchańców", 
      "dmuchane zamki", 
    ...
    <main>
      <section className="rounded-b-[5rem] bg-primaryc pb-40 pt-52">
        <div className="container mx-auto px-4">
          <h1 className="text-center text-3xl font-bold text-white lg:text-5xl">{attraction.name}</h1>
